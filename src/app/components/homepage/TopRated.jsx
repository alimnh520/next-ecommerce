    ...
    return (
        <div className="h-full relative">
            <div className="w-full flex items-center justify-between">
                ...
                <div className="custom-prev flex size-8 text-2xl text-gray-400 items-center justify-center border border-gray-400 hover:bg-gray-400 hover:text-white transition-all duration-400 shadow-lg absolute right-10 z-10 cursor-pointer"><IoIosArrowBack /></div>
            </div>
